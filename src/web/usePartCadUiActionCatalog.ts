...
export function usePartCadUiActionCatalog(options: PartCadUiActionCatalogOptions) {
  ...
  return useM2CadUiActions({
    ...
    linearDimension: ignoreResult(workspace.beginLinearDimension),
    ...
    diameterDimension: ignoreResult(workspace.beginDiameterDimension),
    ...
    canApplyLineDimension: workspace.canApplyLineDimension,
