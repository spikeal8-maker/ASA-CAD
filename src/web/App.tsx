...
const{ activeWorkspace,setActiveWorkspace,activeCommand,activeSketchId,selectedSketchEntityId,applyHorizontalConstraint,applyVerticalConstraint,applyFixedConstraint,selectionMode,selectedPick,selectedBodyId,sketchPlane,setSketchPlane,rectangleWidth,setRectangleWidth,rectangleHeight,setRectangleHeight,circleDiameter,setCircleDiameter,extrudeDistance,setExtrudeDistance,filletRadius,setFilletRadius,dimensionEditValue,setDimensionEditValue,part,sketch,rectangleReady,circleReady,hasSolid,canExtrude,canCut,canFillet,selectedPointText,selectedBody,clearTransientSelection,clearSelectedPick,resetTransient,resetToWorkspace,resetForDocument,handleViewportPick,handleBodySelect,handleSketchEntitySelect,deleteSelectedSketchEntity,translateSketchEntity,enterSketch,beginLine,lineDraft,lineCommitting,handleSketchLinePointMove,handleSketchLinePoint,rectangleDraft,rectangleCommitting,handleSketchRectanglePointMove,handleSketchRectanglePoint,circleDraft,circleCommitting,handleSketchCirclePointMove,handleSketchCirclePoint,beginArc,arcDraft,arcCommitting,handleSketchArcPointMove,handleSketchArcPoint,beginCreateSketch,commitCreateSketch,beginRectangle,commitRectangle,beginCircle,commitCircle,finishSketch,beginExtrude,commitExtrude,beginCut,commitCut,beginFillet,commitFillet,beginDimensionEdit,commitDimensionEdit,cancelCommand,commitActiveCommand}=workspace;
  ...
  const replacement=useDocumentReplacementGuard({dirty:state.dirty,save:saveLocal,open:openLocal,onCreate:createDocument});
  ...
  const uiActions = usePartCadUiActionCatalog({
    ...
    newDocument:replacement.newDocument, open:replacement.openDocument, save:saveLocal, undo, redo, rebuild,
