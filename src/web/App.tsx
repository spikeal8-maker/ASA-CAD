...
export function App(props: CadProjectPersistenceOverrides) {
  ...
  const uiActions = usePartCadUiActionCatalog({
    ...
    open: openLocal, save: saveLocal, undo, redo, rebuild,
