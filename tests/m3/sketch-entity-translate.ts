...
assert.throws(
  () => translateSketchEntity(line, [Number.NaN, 0]),
...
app.dispose();
console.log('ASA-CAD M3.6B Sketch entity translate PASS (rigid DTO semantics + stable ID + rollback + history + transient candidate)');
