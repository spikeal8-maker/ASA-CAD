...
assert.match(geometry, /\sA\s/, 'Arc rendering must use the native SVG elliptical-arc command');
assert.equal(geometry.includes('segments'), false, 'Arc rendering must not use fixed chord tessellation');
