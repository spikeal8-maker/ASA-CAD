...
for (const legacyCase of [
  ...
  "case 'dimension.linear':", "case 'dimension.horizontal':", "case 'dimension.vertical':", "case 'dimension.diameter':", "case 'dimension.radius':", "case 'dimension.angular':", "case 'part.dimension.setValue':",
]) {
...
const families = [
  ...
  { name: 'dimension', source: dimensions, ids: ['dimension.linear', 'dimension.horizontal', 'dimension.vertical', 'dimension.diameter', 'dimension.radius', 'dimension.angular', 'part.dimension.setValue'] },
];
