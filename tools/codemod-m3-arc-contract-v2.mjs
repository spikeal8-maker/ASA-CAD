...
if (fs.readFileSync('src/contracts/sketch.ts', 'utf8').includes('export interface CadSketchArcData')) {
  console.log('M3.4A Arc contract already applied');
  process.exit(0);
}
...
replaceOnce('src/contracts/sketch.ts',
...
replaceOnce('src/contracts/document.ts',
`  CadSketchCircleData,\n  CadSketchCircleEntity,\n  CadSketchEntity,`,
`  CadSketchCircleData,\n  CadSketchCircleEntity,\n  CadSketchArcData,\n  CadSketchArcEntity,\n  CadSketchEntity,`);

replaceOnce('src/contracts/commands.ts',
`  | 'sketch.circle'\n  | 'sketch.finish'`,
`  | 'sketch.circle'\n  | 'sketch.arc'\n  | 'sketch.finish'`);
replaceOnce('src/contracts/commands.ts',
...
replaceOnce('src/application/commands/SketchCommandHandlers.ts',
`  'sketch.circle',\n  'sketch.finish',`,
`  'sketch.circle',\n  'sketch.arc',\n  'sketch.finish',`);
replaceOnce('src/application/commands/SketchCommandHandlers.ts',
...
replaceOnce('src/runtime/PlaneGCSSketchSolverRuntime.ts',
...
const runtimePath = 'src/runtime/PlaneGCSSketchSolverRuntime.ts';
let runtime = fs.readFileSync(runtimePath, 'utf8');
if (!runtime.includes('const ARC_TWO_PI')) {
...
replaceOnce('tests/m2o/sketch-contract-boundary.mjs',
